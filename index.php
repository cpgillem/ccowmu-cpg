  ...
  <body>
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          <?php
            /* Get last thursday's minutes and a link to their page. */
            $lastThursday = strtotime("last thursday", time());
            $cclubPage = sprintf("https://cclub.cs.wmich.edu/minutes/%s/minutes.html", date("Y/m/d", $lastThursday));
            $minutes = file_get_contents(sprintf("https://raw.githubusercontent.com/ccowmu/minutes/master/minutes/%s.md", date("Ymd", $lastThursday)));
